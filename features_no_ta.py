...
# VWAP (Volume Weighted Average Price) - 手動計算
...
# 移除中間計算欄位
df.drop(columns=['typical_price', 'vwap_numerator', 'vwap_denominator', 
                'VWAP_20_numerator', 'VWAP_20_denominator'], inplace=True)
...
print("\n特徵已儲存至 data/cleaned_features.csv")